      ...
      <div className="about">
        <div className="about-section-1">
          ...
          <p>
            ...
            internet (remember dial-up?), which I've always found fascinating. I  began my web development journey in April 2018, and I've been working to hone my skills ever since. I graduated Eleven Fifty Academy's Web Development bootcamp in October 2021, and I'm always working on a project while I search for the right junior developer role for me.
          </p>
          <p>
          ...
          <p>
            When I'm not changing the world one line of code at a time, I enjoy listening to music - ranging from classic rock to EDM or watching some of my favorite shows - like Supernatural or Sherlock.
          </p>
          <p>
